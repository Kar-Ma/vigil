...
export default function Home() {
  return <main id="top">
    ...
    <footer className="footer shell"><Brand /><p>Vigil is open source and built in public.</p><div><a href={githubUrl} target="_blank" rel="noreferrer">GitHub ↗</a><a href="/support">Support</a><a href="/privacy">Privacy</a><a href="/security">Security</a></div></footer>
  </main>;
}
